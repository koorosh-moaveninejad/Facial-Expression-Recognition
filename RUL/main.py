...
def train():
    ...
    #Data Transforms for validation ( without augmentation)
    ...
    #train_dataset_eval used for evaluation training accuracy without augmentation
    ...
    optimizer = torch.optim.Adam([
        {'params': res18.parameters()}, # backbone + uncertainty branches
        {'params': fc.parameters(), 'lr': 0.002} # classifier with higher LR
    ...
    for i in range(1, args.epochs + 1):
        ...
        for batch_i, (imgs, labels, indexes) in enumerate(train_bar):
            ...
            loss_func = mixup_criterion(y_a, y_b) #loss of both labels (0.5*CE(y_a) + 0.5*CE(y_b))
